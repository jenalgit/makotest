...
<div id="main" role="main">
		...
		$grade=$data->grade;
		?>
<form method="post" action="<?php echo URL::to('example/nilaiUpdate/'.$id);?>" name="editnilai" >
<input type="hidden" value="<?=$id?>" name="id">
<table border=0>
<tr><th>Nim</th><td>:</td><td><input type="text" name="nim" maxlength="8" value="<?=$nim?>"   onkeypress="return harusangka(event)"/></td></tr>
<tr><th>matkul</th><td>:</td><td><input type="text" name="matkul" maxlength="30" value="<?=$matkul?>"/></td></tr>
<tr><th>Grade</th><td>:</td><td><input type="text" name="grade" maxlength="1" size="1" value="<?=$grade?>" /></td></tr>
<tr><td colspan="3"><input type="submit" value="edit"/> | <input type="reset" value="cancel"/></td></tr>
</table>
</form>
		</div>
</div>
