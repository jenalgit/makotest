...
<b>Add Nilai Mahasiswa</b><br>
<form method="post" action="<?php echo URL::to('example/nilaiAdd/');?>" name="addnilai" onsubmit=" return cekFormnilai('addnilai')">
<table border=0>
<tr><th>Nim</th><td>:</td><td><input type="text" name="nim" maxlength="8"  onkeypress="return harusangka(event)"/></td></tr>
<tr><th>matkul</th><td>:</td><td><input type="text" name="matkul" maxlength="30"/></td></tr>
<tr><th>Grade</th><td>:</td><td><input type="text" name="grade" maxlength="1" size="1" onkeypress="return grade(event)"/></td></tr>
