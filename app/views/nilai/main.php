...
<div id="main" role="main">
		...
		<h2 id="title"> Manajemen Nilai</h2>
		<a href="<?php echo URL::to('example/nilaiAdd/');?>">Add</a>
		<table id="tabeldata">
		<thead><tr><th>No</th><th>Nim</th><th>Matkul</th><th>Grade</th><th>Action</th></tr></thead>
		<tbody>
		<?php
		$n=1;
		foreach($data as $nilai)
		{
			echo "<tr><td>$n</td><td>$nilai->nim</td><td>$nilai->matkul</td><td>$nilai->grade</td><td><a href='".URL::to('example/nilaiUpdate/'.$nilai->id)."'>edit</a> | <a href='".URL::to('example/nilaiDelete/'.$nilai->id)."'>delete</a></td></tr>";
		$n++;
		}
