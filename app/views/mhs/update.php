...
<div id="main" role="main">
		...
		$nama=$data->nama;
		?>
		<form method="post" action="<?php echo URL::to('example/mhsUpdate/'.$nim);?>" name="editmhs" onsubmit=" return cekFormmhs()">
<input type="hidden" value="<?php echo $nim;?>" name="oldnim">
<table border=0>
<tr><th>Nama</th><td>:</td><td><input type="text" name="nama" maxlength="30" value="<?php echo $nama;?>"/></td></tr>
<tr><th>Nim</th><td>:</td><td><input type="text" name="nim" maxlength="8" value="<?php echo $nim;?>"/></td></tr>
